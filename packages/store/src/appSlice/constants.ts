...
export const emptyChartSelection = { software: '', group: '', chartType: chartTypes.bar.key, attribute: 'artifact_name' } as const;
export const defaultReportType = 'distribution' as const;
...
export const locations = {
  eu: { key: 'eu', title: 'EU', location: 'eu.hosted.mender.io', icon: FlagEU } as const,
  us: { key: 'us', title: 'US', location: 'hosted.mender.io', icon: FlagUS } as const
};
