...
import type { BillingProfile, Event, Integration } from '@northern.tech/store/api/types/MenderTypes';
...
export const organizationSlice = createSlice({
  ...
  initialState,
  reducers: {
    receiveAuditLogs: (state, action: PayloadAction<{ events: Event[]; total: number }>) => {
    ...
    receiveWebhookEvents: (state, action: PayloadAction<{ total: number; value: Event[] }>) => {
