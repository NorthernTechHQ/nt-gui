...
- Added mui component overview to ease seeing theme impact
...
- Fixed an issue that prevent seeing sessiondetails for portforwarding auditlog entries
...
- Fixed an issue with the auditlogs that prevented updating the window url after initialization
...
- Added audit logs component to the @northern.tech/common
